...
/**
 * Servlet implementation class ThumbnailDetailViewContrioller
 */
@WebServlet("/detailView.th")
public class ThumbnailDetailViewContrioller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ThumbnailDetailViewContrioller() {
        super();
