...
public class BoardListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int pageLimit;    // 페이지 하단에 보여질 페이징바의 최대 개수 / 개발자가 정함
		int boardLimit;   // 한 페이지내에 보여질 게시글 최대 개수 / 개발자가 정함
		
		// 위의 4개의 값을 가지고 아래 3개의 값을 구해낼거임
		 ...
		 * 
		 * ex) 페이징바의 목록이 10개 단위씩이라는 가정하에
		 * 	startPage : 1, 11, 21, 32 ,....
		 * 				=> n * pageLimit +1
		 ...
		 * 			 = (currentPage - 1 ) / pageLimit    * pageLimit + 1  // 5 -1 / 10 => 1페이지가 첫
		 * 			 
		 *
		 */
		...
		// * 현재 요청한 페이지 (currentPage)에 보여질 게시글 리스트 boardLimit 조회
